  ...
  return (
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li className="nav-item dropdown">
          ...
          {(user?.email)?(
            <>
             <li className="dropdown-item"> <NavLink to = "/profile" className={renderNavLinkClassName}>{user.email}</NavLink></li>
             <li className="dropdown-item"> <NavLink to = "/logout" className={renderNavLinkClassName}>Logout</NavLink></li>
